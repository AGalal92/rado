                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <form method="post" action="{{ route('admin.student.store') }}">
                            ...
                            <div class="input-group mb-4">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon5">National ID</span>
                                </div>
                            ...
                            <div class="input-group mb-4">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon5">Paid</span>
                                </div>
                                <input type="number" class="form-control" name="pay" placeholder="Paid"
                                    aria-label="Paid">
                            </div>
