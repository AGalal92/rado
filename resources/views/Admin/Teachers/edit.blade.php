                        ...
                        <div class="widget-content widget-content-area">
                            <form method="post" action="{{ route('admin.student.update') }}">
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input type="number" value="{{ $student->price }}" class="form-control"
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input type="date" class="form-control" value="{{ $student->start_date }}"
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input type="date" class="form-control" value="{{ $student->end_date }}"
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <select name="skill_id" class="btn btn-warning dropdown-toggle ml-2">
                                        @foreach ($skill as $skills)
                                            <option @if ($skills->id == $skill->skill_id) selected @endif
                                                value="{{ $skills->id }}">{{ $skills->name }}</option>
                                        @endforeach
                                    </select>
