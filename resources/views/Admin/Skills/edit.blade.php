                        ...
                        <div class="widget-content widget-content-area">
                            <form method="post" action="{{ route('admin.skill.update') }}">
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input type="number" value="{{ $skill->price }}" class="form-control"
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input type="date" class="form-control" value="{{ $skill->start_date }}"
                                        name="start_date" aria-label="Start Date">
                                </div>
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input type="date" class="form-control" value="{{ $skill->end_date }}"
                                        name="end_date" aria-label="End Date">
                                </div>
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <select name="skill_category_id" class="btn btn-warning dropdown-toggle ml-2">
                                        @foreach ($skillCategories as $skillCategory)
                                            <option @if ($skillCategory->id == $skill->skill_category_id) selected @endif
                                                value="{{ $skillCategory->id }}">{{ $skillCategory->name }}</option>
                                        @endforeach
                                    </select>
